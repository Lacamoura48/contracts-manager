...
return [
    ...
    */
    ...
    'accepted' => 'يجب قبول إدخال :attribute',
    ...
    'array' => 'يجب أن يكون إدخال :attribute ًمصفوفة',
    ...
    'doesnt_end_with' => 'إدخال :attribute يجب ألا ينتهي بواحدة من القيم التالية: :values.',
    'doesnt_start_with' => 'إدخال :attribute يجب ألا يبدأ بواحدة من القيم التالية: :values.',
    ...
    'image' => 'يجب أن يكون إدخال :attribute صورةً.',
    'in' => 'حقل المحدد :attribute غير صالح.',
    'in_array' => 'إدخال :attribute غير موجود في :other.',
    'integer' => 'يجب أن يكون إدخال :attribute عددًا صحيحًا',
    ...
    'lowercase' => 'إدخال :attribute يجب ان يكون حروف صغيرة',
    'lt' => [
    ...
    'max' => [
        'array' => 'يجب أن لا يحتوي إدخال :attribute على أكثر من :max عناصر/عنصر.',
    ...
    'max_digits' => 'إدخال :attribute يجب ألا يحتوي أكثر من :max أرقام.',
    'mimes' => 'حقل :attribute يجب ان يكون ملف من نوع: :values.',
    'mimetypes' => 'حقل :attribute يجب ان يكون ملف من نوع: :values.',
    'min' => [
        'array' => 'يجب أن يحتوي إدخال :attribute على الأقل على :min عُنصرًا/عناصر',
        'file' => 'يجب أن يكون حجم الملف :attribute على الأقل :min كيلوبايت',
        'numeric' => 'يجب أن تكون قيمة إدخال :attribute مساوية أو أكبر لـ :min.',
        'string' => 'يجب أن يكون طول نص :attribute على الأقل :min حروفٍ/حرفًا',
    ],
    'min_digits' => 'إدخال :attribute يجب أن يحتوي :min أرقام على الأقل.',
    ...
    'multiple_of' => 'إدخال :attribute يجب أن يكون من مضاعفات :value.',
    'not_in' => 'إدخال المحدد :attribute غير صالح',
    ...
    'present' => 'يجب تقديم إدخال :attribute',
    'prohibited' => 'إدخال :attribute محظور',
    'prohibited_if' => 'إدخال :attribute محظور في حال ما إذا كان :other يساوي :value.',
    'prohibited_unless' => 'إدخال :attribute محظور في حال ما لم يكون :other يساوي :value.',
    'prohibits' => 'إدخال :attribute يحظر :other من اي يكون موجود',
    'regex' => 'صيغة حقل :attribute غير صالحة.',
    'required' => 'إدخال :attribute مطلوب.',
    'required_array_keys' => 'إدخال :attribute يجب ان يحتوي علي مدخلات للقيم التالية :values.',
    'required_if' => 'إدخال :attribute مطلوب في حال ما إذا كان :other يساوي :value.',
    'required_if_accepted' => 'حقل :attribute مطلوب عندما يكون :other مقبول.',
    'required_unless' => 'إدخال :attribute مطلوب في حال ما لم يكن :other يساوي :values.',
    'required_with' => 'إدخال :attribute مطلوب إذا توفّر :values.',
    'required_with_all' => 'إدخال :attribute مطلوب إذا توفّر :values.',
    'required_without' => 'إدخال :attribute مطلوب إذا لم يتوفّر :values.',
    'required_without_all' => 'إدخال :attribute مطلوب إذا لم يتوفّر :values.',
    'same' => 'يجب أن يتطابق إدخال :attribute مع :other',
    'size' => [
        'array' => 'يجب أن يحتوي إدخال :attribute على :size عنصرٍ/عناصر بالظبط',
        'file' => 'يجب أن يكون حجم الملف :attribute :size كيلوبايت',
        'numeric' => 'يجب أن تكون قيمة إدخال :attribute مساوية لـ :size',
    ...
    'unique' => 'قيمة إدخال :attribute مُستخدمة من قبل',
    ...
    */
    ...
    'attributes' => [
        ...
        'q'                     => 'البحث',
        'link'                  => 'رابط',
        'id_photo_front'                  =>"صورة الهوية (وجه)",
        'id_photo_back'                  => "صورة الهوية (ظهر)",
        // 'slug'                  => ' ',
    ],
